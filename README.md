...
- **Configuration diagnostics:** [failed native checks](docs/configuration-failures.md) identify affected field groups in the conversation, history, and bilingual report, preserve historical successes, and omit native values.
