...
D2/D3 must connect this adapter to the shared coordinator and desktop factory, verify native selected model/policy and session identity, normalize DSH committed messages and context usage truthfully, and exercise cancellation and resume through AgentMatrix's journal. External provider acceptance, remote MCP, general plugin activation, complete application reporting, and other platforms remain separate requirements. This configuration fixture does not pass D4.
