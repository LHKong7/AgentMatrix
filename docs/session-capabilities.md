...
| MCP mapping / connectivity   | OpenCode config or DSH composition for mapping only                         | Connectivity remains unknown. Pi still requires a separately verified extension.                  |
