export const pluginEn = {
  ...
  'plugin.rangeHint':
    'Compared with the saved CLI version. This does not probe the executable or verify runtime compatibility.',
  'plugin.range.matched': 'The declared range includes saved OpenCode version {version}.',
  'plugin.range.mismatched': 'The declared range excludes saved OpenCode version {version}.',
  'plugin.range.undeclared': 'No OpenCode version range is declared; compatibility is unknown.',
  'plugin.range.invalid-range': 'The declared OpenCode version range is invalid.',
