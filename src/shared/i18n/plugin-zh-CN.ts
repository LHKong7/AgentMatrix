...
export const pluginZhCN: Record<keyof typeof pluginEn, string> = {
  ...
  'plugin.rangeHint': '仅与已保存的 CLI 版本比较，不会探测可执行文件，也不证明运行时兼容性。',
  'plugin.range.matched': '声明的范围包含已保存的 OpenCode 版本 {version}。',
  'plugin.range.mismatched': '声明的范围不包含已保存的 OpenCode 版本 {version}。',
  'plugin.range.undeclared': '未声明 OpenCode 版本范围，兼容性未知。',
  'plugin.range.invalid-range': '声明的 OpenCode 版本范围无效。',
